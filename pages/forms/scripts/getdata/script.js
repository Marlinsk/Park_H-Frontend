...
function getData() {
  ...
  return new Promise((resolve) => {
    ...
    dadosAnuncio.horarioFuncionamento = document.querySelector('.form-check-input.horas').value;
    dadosAnuncio.temPortaria = document.querySelector('.form-check-input.porteiro').value
